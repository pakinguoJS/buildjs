...
define(function(require, exports, module){
    ...
    Pagingbar.gotoPage = function(pnum){
        if(pnum > 0 && pnum <= Pagingbar._data.total_page_num){
            ...
            $.get('/cms/index.php/discount/get_more', {
     ...
     * 刷新列表
     */
    var tplListData = require('page/app/discount/discount.list.data.js');
    ...
    function renderList(data){
        if(!data || data.length === 0){
            ...
            for(var i = 0, l = data.length;i < l;i++){
                ...
                .replace(/{bank}/g, data[i].bank)
                .replace(/{card}/g, (data[i].card))
                .replace(/{discount}/g, data[i].discount)
                .replace(/{start_time}/g, data[i].start_time)
                .replace(/{end_time}/g, data[i].end_time)
