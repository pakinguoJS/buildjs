...
define(function(require, exports, module){
    ...
    var restaurant = {
        ...
        addDiscount: function(){
            ...
            $('#addDiscount').click(function(){
                if(!($('#discountFL').val() && $('#discountSL').val() && $('#discountTL').val())) return;
    ...
    $('#restaurant-register-form').validate({
        ...
        submitHandler:function(form) {
            ...
            $.post('/cms/index.php/restaurant/do_register', {
                ...
                if (rs.ret) {
                    ...
                    setTimeout(function(){location.href = '/cms/index.php/rest_verify/index'},2000)
            }
            },'json');
        }
    });
