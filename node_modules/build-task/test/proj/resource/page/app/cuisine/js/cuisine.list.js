...
define(function(require, exports, module){
    ...
    Pagingbar.gotoPage = function(pnum){
        if(pnum > 0 && pnum <= Pagingbar._data.total_page_num){
            ...
            $.get('/cms/index.php/cuisine/get_more', {
     ...
     * 刷新列表
     */
    var tplListData = require('page/app/cuisine/js/cuisine.list.data.js');
    ...
    $('#homeList').delegate('a[data-rel="slevel-preview"]', 'click', function(){
        ...
        $.getJSON('/cms/index.php/cuisine/get_cuisine', {
            ...
            if(rs.ret == 0){
                // 填充列表
                $('#sLevelCuisineList').html(renderSlevelList(rs.data.data.cuisine_list));
    ...
    var tplDataList = require('page/app/cuisine/js/cuisine.list.s.data.js');
