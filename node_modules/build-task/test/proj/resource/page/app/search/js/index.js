...
define(function (require, exports, module) {
	...
	require('ipick.search-preview');
	require('ipick.data-table');
	require('ipick.advanced-pagination');

	$('#modified-preview, #live-preview').searchPreview();
	...
	$('#release-btn').click(function (event) {
		...
		function (data) {
			if (data['ret']) {
				...
				$('#live-preview')
					.searchPreview().clear()
					.searchPreview().addItem($('#modified-preview')
						.searchPreview().getItemList()
					);
			}
		});
	});
