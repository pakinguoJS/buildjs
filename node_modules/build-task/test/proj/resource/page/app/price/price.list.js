...
define(function(require, exports, module){
    ...
    Pagingbar.gotoPage = function(pnum){
        if(pnum > 0 && pnum <= Pagingbar._data.total_page_num){
            ...
            $.get('/cms/index.php/price/get_more', {
     ...
     * 刷新列表
     */
    var tplListData = require('page/app/price/price.list.data.js');
    ...
    function renderList(data){
        if(!data || data.length === 0){
            ...
            for(var i = 0, l = data.length;i < l;i++){
                ...
                .replace(/{min_price}/g, disposeJSON(data[i].min_price))
                .replace(/{max_price}/g, disposeJSON(data[i].max_price))
